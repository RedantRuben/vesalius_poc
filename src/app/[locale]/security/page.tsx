...
export default async function SecurityPage() {
  ...
  return (
    <main className="w-full bg-[#FCFCFD] relative selection:bg-primary/20">
      ...
      {/* Hero Section */}
      <section className="w-full pt-32 pb-20 bg-transparent relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-[#0B1B3D] mb-8 tracking-tight">
            {copy.title}<span className="text-transparent bg-clip-text bg-gradient-to-r from-[#06ACC1] to-cyan-400">{copy.accent}</span>
          </h1>
      ...
      <section className="w-full py-20 bg-transparent">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {/* Data Protection */}
            <div className="bg-white rounded-3xl p-8 md:p-10 border border-slate-200/60 shadow-xl shadow-slate-200/40 hover:shadow-2xl hover:shadow-slate-200/50 hover:-translate-y-1 transition-all duration-500 group relative overflow-hidden">
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#0B1B3D] to-[#06ACC1] opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <div className="w-14 h-14 rounded-2xl bg-[#0B1B3D] text-white shadow-lg shadow-[#0B1B3D]/20 flex items-center justify-center mb-8 group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-500">
                 <LockIcon />
              </div>
              <h3 className="text-2xl font-bold text-[#0B1B3D] mb-4 tracking-tight">{copy.cards[0].title}</h3>
              <p className="text-base text-slate-500 font-light mb-8 leading-relaxed">
                {copy.cards[0].body}
              </p>
              <ul className="space-y-3">
                {copy.commonListItems.map((item, i) => (
            ...
            <div className="bg-white rounded-3xl p-8 md:p-10 border border-slate-200/60 shadow-xl shadow-slate-200/40 hover:shadow-2xl hover:shadow-slate-200/50 hover:-translate-y-1 transition-all duration-500 group relative overflow-hidden">
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#06ACC1] to-cyan-400 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <div className="w-14 h-14 rounded-2xl bg-[#06ACC1] text-white shadow-lg shadow-[#06ACC1]/20 flex items-center justify-center mb-8 group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-500">
                 <ShieldCheckIcon />
              </div>
              <h3 className="text-2xl font-bold text-[#0B1B3D] mb-4 tracking-tight">{copy.cards[1].title}</h3>
              <p className="text-base text-slate-500 font-light mb-8 leading-relaxed">
                {copy.cards[1].body}
              </p>
              <ul className="space-y-3">
            ...
            {/* Data Transparency */}
            <div className="bg-white rounded-3xl p-8 md:p-10 border border-slate-200/60 shadow-xl shadow-slate-200/40 hover:shadow-2xl hover:shadow-slate-200/50 hover:-translate-y-1 transition-all duration-500 group relative overflow-hidden">
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#FF3366] to-rose-400 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#FF3366] to-rose-500 text-white shadow-lg shadow-rose-500/20 flex items-center justify-center mb-8 group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-500">
                 <EyeIcon />
              </div>
              <h3 className="text-2xl font-bold text-[#0B1B3D] mb-4 tracking-tight">{copy.cards[2].title}</h3>
              <p className="text-base text-slate-500 font-light mb-8 leading-relaxed">
                {copy.cards[2].body}
              </p>
              <ul className="space-y-3">
