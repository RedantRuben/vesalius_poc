  ...
  return (
    <section className="w-full bg-[#FCFCFD] relative pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#06ACC1]/10 border border-[#06ACC1]/20 mb-6">
            <span className="w-1.5 h-1.5 rounded-full bg-[#06ACC1]"></span>
            <span className="text-[#06ACC1] font-bold tracking-widest uppercase text-xs">{copy.eyebrow}</span>
          </div>
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#0B1B3D] tracking-tight max-w-4xl leading-tight">
            {t('title')}
          </h2>
        </motion.div>
          ...
          <div className="flex flex-col gap-10 md:gap-14">
            <div className="flex items-center gap-4 md:gap-6 relative z-20">
               ...
               <div className="bg-white/80 backdrop-blur-md border border-slate-200/80 px-6 py-2.5 rounded-full flex items-center gap-3 shadow-[0_2px_12px_-4px_rgba(0,0,0,0.08)]">
                 ...
                 <h3 className="text-xs md:text-sm font-bold text-slate-800 uppercase tracking-[0.15em]">{t('beforeConsultation')}</h3>
               </div>
                ...
                <Link href={`/${locale}/product/agenda`} scroll={true} className="flex flex-col h-full min-h-[420px] bg-white rounded-[2rem] p-8 md:p-12 pb-40 md:pb-48 relative overflow-hidden group hover:shadow-2xl hover:shadow-slate-200/50 hover:-translate-y-1 transition-all duration-500 border border-slate-200/60 hover:border-slate-300/80 cursor-pointer">
                  ...
                  <div className="relative z-10 flex justify-between items-start mb-6">
                    <div className="flex gap-2.5">
                      <span className="bg-blue-50 text-blue-600 px-3 py-1 rounded-full text-xs font-semibold tracking-wide">{t('agenda.tag1')}</span>
                      <span className="bg-blue-50 text-blue-600 px-3 py-1 rounded-full text-xs font-semibold tracking-wide">{t('agenda.tag2')}</span>
                    </div>
                    <ArrowUpRight />
                  </div>
                  
                  <div className="relative z-10 pointer-events-none flex-1">
                    <h3 className="text-2xl md:text-3xl font-bold text-[#0B1B3D] mb-3 tracking-tight">{t('agenda.title')}</h3>
                  ...
                  <div className="absolute bottom-8 left-0 right-0 flex justify-center pointer-events-none group-hover:-translate-y-2 transition-transform duration-700">
                      <div className="w-56 bg-white border border-slate-100 rounded-2xl shadow-xl p-4 relative">
                          <div className="flex justify-between items-center mb-4 border-b border-slate-50 pb-3">
                             <div className="text-xs font-bold text-slate-700 uppercase tracking-wider">Today</div>
                          ...
                          <div className="space-y-4">
                             ...
                             >
                                ...
                                <div className="flex-1">
                                  <div className="h-2 bg-slate-200 rounded-full w-1/2 mb-1.5"></div>
                                  <div className="h-1.5 bg-slate-100 rounded-full w-1/3"></div>
                                </div>
                             </motion.div>
                             <motion.div 
                               initial={{ opacity: 0, x: -10 }}
                             ...
                             >
                                ...
                                <div className="flex-1">
                                  <div className="h-2 bg-slate-200 rounded-full w-2/3 mb-1.5"></div>
                             ...
                             >
                                ...
                                <div className="flex-1">
                                  <div className="h-2 bg-slate-200 rounded-full w-1/2 mb-1.5"></div>
                                  <div className="h-1.5 bg-slate-100 rounded-full w-1/4"></div>
                                </div>
                             </motion.div>
                          </div>
                      </div>
                ...
                <Link href={`/${locale}/product/pre-consultation`} scroll={true} className="flex flex-col h-full min-h-[420px] bg-white rounded-[2rem] p-8 md:p-12 pb-40 md:pb-48 relative overflow-hidden group hover:shadow-2xl hover:shadow-slate-200/50 hover:-translate-y-1 transition-all duration-500 border border-slate-200/60 hover:border-slate-300/80">
                  ...
                  <div className="relative z-10 flex justify-between items-start mb-6">
                    <div className="flex gap-2.5 flex-wrap">
                      <span className="bg-cyan-50 text-cyan-600 px-3 py-1 rounded-full text-xs font-semibold tracking-wide whitespace-nowrap">{t('preConsultation.tag1')}</span>
                      <span className="bg-cyan-50 text-cyan-600 px-3 py-1 rounded-full text-xs font-semibold tracking-wide whitespace-nowrap">{t('preConsultation.tag2')}</span>
                    </div>
                    <ArrowUpRight />
                  </div>
                  ...
                  <div className="relative z-10 pointer-events-none flex-1">
                    ...
                    <p className="text-slate-600 max-w-md text-sm md:text-base leading-relaxed mb-8">
                  ...
                  <div className="absolute bottom-0 right-0 w-full h-1/2 overflow-hidden pointer-events-none">
                    <div className="relative h-full w-full max-w-sm mx-auto transform translate-y-4 group-hover:translate-y-0 transition-transform duration-700">
                      <motion.div  
                        initial={{ opacity: 0, x: 40 }}
                        whileInView={{ opacity: 1, x: 0 }}
                        transition={{ duration: 0.8, ease: "easeOut" }}
                        className="absolute right-4 top-4 w-2/3 bg-white rounded-2xl rounded-tr-sm p-4 shadow-lg border border-slate-100"
                      >
                      ...
                      <motion.div 
                        ...
                        className="absolute left-4 top-24 w-2/3 bg-gradient-to-r from-cyan-50 to-white rounded-2xl rounded-tl-sm p-4 border border-cyan-100 shadow-xl shadow-cyan-900/5"
                      >
              ...
              <motion.div variants={itemVariants} className="lg:col-span-4">
                <Link href={`/${locale}/product/smart-triage`} scroll={true} className="flex flex-col h-full min-h-[420px] bg-white rounded-[2rem] p-8 md:p-12 pb-40 md:pb-48 relative overflow-hidden group hover:shadow-2xl hover:shadow-slate-200/50 hover:-translate-y-1 transition-all duration-500 border border-slate-200/60 hover:border-slate-300/80">
                  ...
                  <div className="absolute bottom-12 left-0 right-0 flex justify-center items-center gap-2 md:gap-4 pointer-events-none group-hover:-translate-y-2 transition-transform duration-700">
                      {/* Nodes */}
                      <motion.div 
                          className="w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-white border border-slate-100 shadow-md flex items-center justify-center text-slate-400 relative z-10 shrink-0"
          ...
          <div className="flex flex-col gap-10 md:gap-14">
            <div className="flex items-center gap-4 md:gap-6 relative z-20">
               ...
               <div className="bg-white/80 backdrop-blur-md border border-slate-200/80 px-6 py-2.5 rounded-full flex items-center gap-3 shadow-[0_2px_12px_-4px_rgba(0,0,0,0.08)]">
                 ...
                 <h3 className="text-xs md:text-sm font-bold text-slate-800 uppercase tracking-[0.15em]">{t('duringConsultation')}</h3>
               </div>
               <div className="h-px bg-gradient-to-l from-transparent via-slate-200 to-slate-200 flex-1"></div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <motion.div variants={itemVariants} className="lg:col-span-6">
                <Link href={`/${locale}/product/scribe`} scroll={true} className="flex flex-col h-full min-h-[420px] bg-white rounded-[2rem] p-8 md:p-12 pb-40 md:pb-48 relative overflow-hidden group hover:shadow-2xl hover:shadow-slate-200/50 hover:-translate-y-1 transition-all duration-500 border border-slate-200/60 hover:border-slate-300/80">
